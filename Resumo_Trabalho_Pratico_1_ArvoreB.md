...
Busca registros no arquivo de dados baseado em critérios específicos.

**Regra de ouro:** Se o campo de busca for a chave primária (`codEstacao`), a busca *obrigatoriamente* deve ser feita pelo índice Árvore-B.
